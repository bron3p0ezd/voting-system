...
#### Проверочный запуск двух сценариев дал следующие результаты:
| Сценарий | Успешных запросов | Длительность измерения | Успешных RPS | Error rate | p95 |
|---|---:|---:|---:|---:|---:|
| GET `/api/v1/polls/{poll_id}` | 62 645 | 62,48 с | 1 002,59 | 0,00 % | 670 мс |
| POST `/api/v1/polls/{poll_id}/votes` | 20 158 | 61,22 с | 329,26 | 0,00 % | 9 800 мс |
